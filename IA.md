...
_"J'ai utilisé Perplexity AI pour générer la fonction `getArticles` du fichier
`index.php de l'application._

_La fonction `getArticles` a pour but de récupérer les articles depuis la base
de données et de les afficher sur la page d'accueil de l'application._
...
_"J'ai utilisé Google Gemini pour générer la fonction `getArticles` du fichier
`index.php de l'application._
...
spécifique en l'utilisant comme un coach dans mon processus de développement._
...
moi-même. J'ai veillé à comprendre les suggestions de Microsoft Copilot et à les
ajuster pour qu'elles correspondent à mes besoins et s'intègrent correctement
dans le projet."_
