...
|    Mardi | [Utiliser SQLite avec PHP (présentation)](./01-contenus-du-cours/03-utiliser-sqlite-avec-php/README.md) + Réalisation du modèle conceptuel (MCD) et logiques (MLD) de la base de données à partir des données brutes. | Création de la base de données (MPD).                                                                                                                                                                                                                                                                                   |
